...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full bg-white top-0 border-[2px]  shadow-md">
      {toggleDrop && (
        <div className="absolute border-[2px] w-full h-[300px] top-12 bg-white  ">
          ...
          <div className="text-center flex justify-center gap-5">
            ...
            <button
              onClick={() => {}}
              className="hover:text-blue-700 z-50 border-[2px]  px-4 rounded-md"
            >
              logout
            </button>
          </div>
      ...
      <div className="flex w-full  justify-between px-5  overflow-x-hidden bg-white  p-2">
        ...
        <button
          className="md:hidden  right-0 relative"
          onClick={() => {
          ...
          {isAuthenticated ? (
            <>
              <div>
                ...
                {showOut && (
                  <div className="absolute  shadow-sm p-2 top-40 md:top-28 rounded-md shadow-black ">
                    <button
                      onClick={() => {}}
                      className="hover:text-blue-700 z-50"
                    >
                      logout
                    </button>
                  </div>
            ...
            <button
              className='border-[1px] hover:bg-blue-800 hover:text-white rounded-[10px] 
