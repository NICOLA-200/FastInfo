    ...
    <div>
      <div className="grid lg:grid-cols-2 px-8 sm:px-24 lg:px-32">
        <div className="flex flex-col">
          ...
          <button onClick={() => {navigate("/registrationProcess")}} className="bg-[#2871FF]  mt-4 text-white w-[160px] h-[50px] m-auto rounded-[20px]">
            Register
          </button>
        </div>
        <div className="flex flex-col">
          ...
          <button onClick={() => {navigate('/searchPage')}} className="bg-[#2871FF] mt-4 text-white w-[160px] h-[50px] m-auto rounded-[20px]">
            Search
          </button>
        </div>
      </div>
